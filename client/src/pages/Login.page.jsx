...
export default function LoginPage({setLogging}) {
  ...
  return (
    <Grid container component="main" className={classes.root}>
      <CssBaseline />
      <Grid item xs={false} sm={4} md={7} className={classes.image} src='./PizzaImage'/>
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} onSubmit={logInHandler} noValidate>
            ...
            <TextField
              ...
              onChange={(e) => setPaswordFormValue(e.target.value)}
